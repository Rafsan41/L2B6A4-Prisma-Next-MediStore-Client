...
import {
  Pill, ShieldCheck, Truck, Clock, Star,
} from "lucide-react"
...
function BrandPanel() {
  return (
    <div className="relative hidden flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/80 p-12 lg:flex">
      ...
      {/* Stats strip */}
      <div className="grid w-full max-w-xs grid-cols-3 gap-1 overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm ring-1 ring-white/10">
        {[
